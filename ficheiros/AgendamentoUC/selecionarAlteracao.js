...
var cursoData = JSON.parse(localStorage.getItem('cursoData'));
...
var selcionarAula = function(cell, formatterParams, onRendered) {
    ...
    button.addEventListener("click", function() {
            ...
            cursoData.forEach((aula,index) => {
                if(aula.Curso === aulaAnterior.Curso &&
                    ...
                    aula["Sala atribuida a aula"] === aulaAnterior["Sala atribuida a aula"]) {
                        cursoData.splice(index, 1);
                        cursoData.push(novaAula);
                    }
        ...
        window.open('./SlotsDisponiveis.html');
    }
});
