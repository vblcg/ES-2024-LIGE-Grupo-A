...
var selcionarAula = function(cell, formatterParams, onRendered) {
    ...
    button.addEventListener("click", function() {
        ...
        if (window.confirm("Este método é irreversível, deseja continuar?")) {
            var columnToRemove = "Selecionar aula";
            var column = table.getColumn(columnToRemove);
            if (column) {
                column.delete();
            } else {
                console.error("Column not found:", columnToRemove);
            }
...
columns: [
    ...
    {title: "Dia da Semana", field:"Dia da Semana", editor:"list", width:100 ,headerFilter:true, headerFilterParams:{values:{"Seg":"Segunda-feira", "Ter":"Terça-feira", "Qua":"Quarta-feira", "Qui":"Quinta-feira" ,"Sex":"Sexta-feira", "Sáb":"Sábado", "Dom":"Domingo"}}},
...
/**
 * Converter uma variável do tipo json para uma variável do tipo csv
 * @param {*} data - Data a ser inserida no ficheiro csv
 * @returns csvContent
 */
...
/**
* Criar dois ficheiros, um csv e um json, e descarregar os mesmos
* @param {*} horario - Variável json que contem o horário
*/
function downloadCSVJSON(horario){
